...
// Lab2Simple.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CLab2SimpleApp

CLab2SimpleApp theApp;


// инициализация CLab2SimpleApp
...
// обработчики сообщений CLab2SimpleApp
